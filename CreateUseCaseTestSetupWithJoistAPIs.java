public class CreateUseCaseTestSetupWithJoistAPIs {
    public static void main(String[] args) {
      ...
      a.insertRoleFeatureReason(1, "Developer", "A BDD Test Framework",
          "I can evaluate how much value I add", 1000.0);
      a.insertArble("FibonacciFunction", 1);
      a.insertRoleFeatureReason(2, "Developer",
          "Fibonacci function accepting one sequence number and returning the "
          + "corresponding Fibonacci #",
          "I can yield Fibonacci numbers", 500.0);
      a.insertArble("AddFunction", 1);
      a.insertRoleFeatureReason(3, "Developer",
          "Add function accepting two numbers and returning the sum",
          "I can add Fibonacci #s", 500.0);
      a.insertBranch(1, 2);
