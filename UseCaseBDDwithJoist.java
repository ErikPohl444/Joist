...
public class UseCaseBDDwithJoist {
  ...
  public static Iterable<Object[]> data() {
    ...
    return Arrays.asList(Joist.getJoist(testcase));
  }
  ...
  public static void setUpTests() {
    ...
    System.out.printf(
        "Beginning to Joist the Junit testing of Application %s [%d].",
  ...
  public void executeTestFibwithJoist() {
    ...
    int scenarioid =
        Integer.parseInt(Joist.parseTestCode(TestCode, "JoistScenarioId"));
